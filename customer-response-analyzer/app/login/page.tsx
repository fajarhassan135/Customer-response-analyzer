  ...
  return (
    <div style={{ minHeight: "100vh", backgroundColor: C.bg, display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "sans-serif", padding: "40px 20px" }}>
      <div style={{ width: "100%", maxWidth: 420 }}>
        <h1 style={{ fontSize: 28, fontWeight: 700, color: C.text, marginBottom: 8 }}>Log in</h1>
        <p style={{ fontSize: 14, color: C.sub, marginBottom: 32 }}>Welcome back. Continue analyzing customer messages.</p>
        ...
        <p style={{ textAlign: "center", fontSize: 13, color: C.sub, marginTop: 20 }}>
          Don&apos;t have an account? <a href="/signup" style={{ color: C.indigo, textDecoration: "none", fontWeight: 600 }}>Sign up</a>
        </p>
      </div>
    </div>
  );
